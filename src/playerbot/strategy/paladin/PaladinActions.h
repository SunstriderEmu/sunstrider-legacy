...
namespace ai
{
    ...
    public:
        ...
        virtual std::string getName() { return "holy light on party"; }
    };
    ...
    public:
        ...
        virtual std::string getName() { return "flash of light on party"; }
    };
    ...
    public:
        ...
        virtual std::string getName() { return "lay on hands on party"; }
    };
