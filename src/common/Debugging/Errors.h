...
namespace Trinity
{
    ...
    DECLSPEC_NORETURN TC_COMMON_API void DebugAssert(char const* file, int line, char const* function, std::string debugInfo, char const* message, char const* format, ...) ATTR_PRINTF(6, 7);
