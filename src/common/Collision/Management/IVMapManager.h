    ...
    class TC_COMMON_API IVMapManager
    {
        ...
        public:
            ...
            */
            ...
            virtual bool GetLiquidLevel(uint32 pMapId, float x, float y, float z, uint8 ReqLiquidTypeMask, float &level, float &floor, LiquidType& typeMask, uint32& mogpFlags) const=0;
