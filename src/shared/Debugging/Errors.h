...
namespace Trinity
{
    ...
    DECLSPEC_NORETURN void DebugAssert(char const* file, int line, char const* function, char const* message) ATTR_NORETURN;
    ...
    DECLSPEC_NORETURN void DebugAssert(char const* file, int line, char const* function, char const* message, char const* format, ...) ATTR_NORETURN ATTR_PRINTF(5, 6);
...
//Only assert when TRINITY_DEBUG is true
#define DEBUG_ASSERT WPDebugAssert
