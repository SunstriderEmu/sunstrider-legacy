...
{                                                                   /* thread-safe */
    ...
    /*0x2D1*/ { "CMSG_MOVE_NOT_ACTIVE_MOVER",       STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleNotActiveMoverOpcode      },
    ...
    /*0x2EA*/ { "CMSG_PET_STOP_ATTACK",             STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     },
    ...
    /*0x391*/ { "CMSG_TIME_SYNC_RESP",              STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleAllowMoveAckOpcode        },
    ...
    /*0x3F7*/ { "CMSG_SPELLCLICK",                  STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     },
