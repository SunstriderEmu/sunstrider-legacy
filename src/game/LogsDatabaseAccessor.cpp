...
void LogsDatabaseAccessor::GMCommand(WorldSession const* m_session, Unit const* target, std::string const& fullcmd)
{
    ...
    stmt->setString(11, (player->GetSelectedUnit()) ? player->GetSelectedUnit()->GetName() : "");
    stmt->setUInt32(12, (player->GetSelectedUnit()) ? player->GetSelectedUnit()->GetMapId() : 0);
    stmt->setFloat(13, (player->GetSelectedUnit()) ? player->GetSelectedUnit()->GetPositionX() : 0);
    stmt->setFloat(14, (player->GetSelectedUnit()) ? player->GetSelectedUnit()->GetPositionY() : 0);
    stmt->setFloat(15, (player->GetSelectedUnit()) ? player->GetSelectedUnit()->GetPositionZ() : 0);
