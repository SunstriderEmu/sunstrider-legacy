...
{
    QueryResult *result = CharacterDatabase.Query( "SELECT creatorGUID, giftCreatorGUID, count, duration, charges, flags, enchantments, randomPropertyId, textID, durability, itemguid,item_template FROM auctionhouse" );
