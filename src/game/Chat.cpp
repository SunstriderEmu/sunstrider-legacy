...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "setvalue64",     SEC_ADMINISTRATOR,false, &ChatHandler::HandleSetValue64,                 "", NULL },
        { "setvaluefloat",  SEC_ADMINISTRATOR,false, &ChatHandler::HandleSetValueFloat,              "", NULL },
        { "getvalue",       SEC_GAMEMASTER3,  false, &ChatHandler::HandleGetValue,                   "", NULL },
        { "getvalue64",     SEC_GAMEMASTER3,  false, &ChatHandler::HandleGetValue64,                 "", NULL },
        { "getvaluefloat",  SEC_GAMEMASTER3,  false, &ChatHandler::HandleGetValueFloat,              "", NULL },
