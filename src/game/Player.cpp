...
bool Player::LoadFromDB( uint32 guid, SQLQueryHolder *holder )
{
    ...
    if(sWorld.getConfig(CONFIG_ARENASERVER_ENABLED))
    {
        if(!HasSpell(44383)) //[Ench. de bouclier (R�silience) frFR]
            addSpell(44383,true);
        ...
        if(m_class == CLASS_PRIEST)
        {
            ...
            {
                if(!HasSpell(25441)) //[R�action, rang 6 frFR]
                    addSpell(25441,true);
                if(!HasSpell(25437)) // [Pri�re du d�sespoir, rang 8 frFR]
                    addSpell(25437,true);
            } else if (m_race == RACE_DWARF) {
                if(!HasSpell(25437)) // [Pri�re du d�sespoir, rang 8 frFR]
                    addSpell(25437,true);
                if(!HasSpell(44047)) //  [Ch�tier, rang 6 frFR]
                    addSpell(44047,true);
            } else if (m_race == RACE_NIGHTELF) {
                if(!HasSpell(25446)) //  [Eclats stellaires, rang 8 frFR]
                    addSpell(25446,true);
                if(!HasSpell(2651)) //  - [Gr�ce d'Elune frFR]
                    addSpell(2651,true);
            } else if (m_race == RACE_DRAENEI) {
                if(!HasSpell(44047)) //  44047 - [Ch�tier, rang 6 frFR]
                    addSpell(44047,true);
                if(!HasSpell(32548)) //  32548 - [Symbole d'espoir frFR]
                    addSpell(32548,true);
            } else if (m_race == RACE_UNDEAD_PLAYER) {
                if(!HasSpell(25467)) //  25467 - [Peste d�vorante, rang 7 frFR]
                    addSpell(25467,true);
                if(!HasSpell(25461)) //  25461 - [Toucher de faiblesse, rang 7 frFR]
                    addSpell(25461,true);
            } else if (m_race == RACE_TROLL) {
                if(!HasSpell(25470)) //  25470 - [Mal�fice de faiblesse, rang 7 frFR]
                    addSpell(25470,true);
            ...
            SetSkill(160, 375, 375); // 160 - masse � deux mains
            ...
            if(!HasSpell(20271)) //jugement le vrai !
                addSpell(20271,true);
            if(!HasSpell(21084)) // Seau de pi�t� rang 1
                addSpell(21084,true);
            ...
            if(GetTeam() == ALLIANCE)
            {
                if(!HasSpell(32182)) // 32182 - [H�ro�sme frFR]
                    addSpell(32182,true);
            } else {
            ...
            SetSkill(54, 375, 375); //54 - [Masses � une main frFR][passif]
        }
    }
