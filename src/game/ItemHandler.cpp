...
void WorldSession::HandleSplitItemOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_SPLIT_ITEM");
    uint8 srcbag, srcslot, dstbag, dstslot, count;

    recvData >> srcbag >> srcslot >> dstbag >> dstslot >> count;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u, dstslot = %u, count = %u", srcbag, srcslot, dstbag, dstslot, count);
...
void WorldSession::HandleSwapInvItemOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_SWAP_INV_ITEM");
    uint8 srcslot, dstslot;

    recvData >> srcslot >> dstslot;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive srcslot = %u, dstslot = %u", srcslot, dstslot);
...
void WorldSession::HandleSwapItem( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_SWAP_ITEM");
    uint8 dstbag, dstslot, srcbag, srcslot;

    recvData >> dstbag >> dstslot >> srcbag >> srcslot ;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u, dstslot = %u", srcbag, srcslot, dstbag, dstslot);
...
void WorldSession::HandleAutoEquipItemOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_AUTOEQUIP_ITEM");
    uint8 srcbag, srcslot;

    recvData >> srcbag >> srcslot;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive srcbag = %u, srcslot = %u", srcbag, srcslot);
...
void WorldSession::HandleDestroyItemOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_DESTROYITEM");
    uint8 bag, slot, count, data1, data2, data3;

    recvData >> bag >> slot >> count >> data1 >> data2 >> data3;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive bag = %u, slot = %u, count = %u", bag, slot, count);
...
void WorldSession::HandleItemQuerySingleOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_ITEM_QUERY_SINGLE");
    uint32 item;
    recvData >> item;
    ...
    if( pProto )
    {
        ...
        for(int s = 0; s < 5; s++)
        {
            ...
            SpellEntry const* spell = sSpellMgr->GetSpellInfo(pProto->Spells[s].SpellId);
            if(spell)
            {
...
void WorldSession::HandleReadItem( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME", "WORLD: CMSG_READ_ITEM");
    ...
    if( pItem && pItem->GetProto()->PageText )
    {
        ...
        if( msg == EQUIP_ERR_OK )
        {
            ...
            TC_LOG_DEBUG("FIXME","STORAGE: Item page sent");
        }
        else
        {
            data.Initialize( SMSG_READ_ITEM_FAILED, 8 );
            TC_LOG_DEBUG("FIXME","STORAGE: Unable to read item");
...
void WorldSession::HandleAutoStoreBagItemOpcode( WorldPacket & recvData )
{
    ...
    //TC_LOG_DEBUG("FIXME","WORLD: CMSG_AUTOSTORE_BAG_ITEM");
    uint8 srcbag, srcslot, dstbag;

    recvData >> srcbag >> srcslot >> dstbag;
    //TC_LOG_DEBUG("FIXME","STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u", srcbag, srcslot, dstbag);
...
void WorldSession::HandleBuyBankSlotOpcode(WorldPacket& /*recvPacket*/)
{
    ...
    TC_LOG_DEBUG("FIXME","PLAYER: Buy bank bag slot, slot number = %u", slot);
