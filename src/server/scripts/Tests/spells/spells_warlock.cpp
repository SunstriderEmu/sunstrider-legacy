...
public:
    ...
    {
        return std::make_unique<CorruptionTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfAgonyTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfDoomTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfRecklessnessTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfElementsTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfTonguesTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CurseOfWeaknessTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<DeathCoilTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<DrainLifeTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<DrainManaTestImpt>();
    }
};
...
public:
    ...
    public:
        ...
        void Test() override
        {
            ...
            TEST_CHANNEL_DAMAGE(warlock, rogue, ClassSpells::Warlock::DRAIN_SOUL_RNK_5, 5, expectedTickAmount);
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<DrainSoulTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<FearTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<HowlOfTerrorTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<LifeTapTestImpt>();
    }
};
...
public:
    ...
    public:
        ...
        void Test() override
        {
            ...
            TEST_DIRECT_SPELL_DAMAGE(warlock, dummy1, ClassSpells::Warlock::SEED_OF_CORRUPTION_RNK_1_DETONATION, expectedDetonationMin, expectedDetonationMax, false, dirtyCallback);
            TEST_DIRECT_SPELL_DAMAGE(warlock, dummy1, ClassSpells::Warlock::SEED_OF_CORRUPTION_RNK_1_DETONATION, expectedDetonationMin * 1.5f, expectedDetonationMax * 1.5f, true, dirtyCallback);
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SeedOfCorruptionTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<BanishTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CreateFirestoneTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CreateHealthstoneTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CreateSoulstoneTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<CreateSpellstoneTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<DemonArmorTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<FelArmorTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<HealthFunnelTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<ShadowWardTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SoulshatterTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonDreadsteedTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonFelhunterTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonFelsteedTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonImpTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonSuccubusTestSuccubust>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SummonVoidwalkerTestVoidwalkert>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<UnendingBreathTestVoidwalkert>();
    }
};
...
public:
    ...
    public:
        ...
        void Test() override
        {
            ...
            TEST_CHANNEL_DAMAGE(warlock, dummy, ClassSpells::Warlock::HELLFIRE_RNK_4, 15, expectedTickAmount, ClassSpells::Warlock::HELLFIRE_RNK_4_TRIGGER);
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<HellfireTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<ImmolateTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<IncinerateTestImpt>();
    }
};
...
public:
    ...
    public:
        ...
        void Test() override
        {
            ...
            TEST_CHANNEL_DAMAGE(warlock, dummy, ClassSpells::Warlock::RAIN_OF_FIRE_RNK_5, 4, expectedTickAmount, ClassSpells::Warlock::RAIN_OF_FIRE_RNK_5_PROC);
        }
    };

    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<RainOfFireTestImpt>();
    }
};
...
public:
    ...
    public:
        ...
        void Test() override
        {
            ...
            // High threat
            TEST_THREAT(warlock, dummy, ClassSpells::Warlock::SEARING_PAIN_RNK_8, 2.f);
        }
    };

    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SearingPainTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<ShadowBoltTestImpt>();
    }
};
...
public:
    ...
    std::unique_ptr<TestCase> GetTest() const override
    {
        return std::make_unique<SoulFireTestImpt>();
    }
};
