...
public:
    ...
    {
        return new instance_blackrock_depths_script(map);
    }

    struct instance_blackrock_depths_script : public InstanceScript
    {
        instance_blackrock_depths_script(Map *pMap) : InstanceScript(pMap) { Initialize(); };
