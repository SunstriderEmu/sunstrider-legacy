...
bool GossipHello_npc_ragged_john(Player* pPlayer, Creature* pCreature)
{
    ...
    pPlayer->SEND_GOSSIP_MENU_TEXTID(2713, pCreature->GetGUID());
    return true;
}
...
void AddSC_burning_steppes()
{
    ...
    newscript->OnGossipHello =  &GossipHello_npc_ragged_john;
    newscript->OnGossipSelect = &GossipSelect_npc_ragged_john;
