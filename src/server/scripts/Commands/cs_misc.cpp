...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        static std::vector<ChatCommand> commandTable =
        {
            ...
            { "senditems",      SEC_GAMEMASTER3,  true,  &HandleSendItemsCommand,           "" },
            { "sendmoney",      SEC_GAMEMASTER3,  true,  &HandleSendMoneyCommand,           "" },
            { "sendmessage",    SEC_GAMEMASTER3,  true,  &HandleSendMessageCommand,         "" },
