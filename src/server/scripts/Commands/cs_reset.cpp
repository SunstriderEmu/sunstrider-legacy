...
static bool HandleResetHonorCommand (const char * args)
{
...
static bool HandleResetLevelCommand(const char * args)
{
    char* pName = strtok((char*)args, "");
    Player *player = nullptr;
    if (pName)
...
static bool HandleResetStatsCommand(const char * args)
{
    char* pName = strtok((char*)args, "");
    Player *player = nullptr;
    if (pName)
...
static bool HandleResetSpellsCommand(const char * args)
{
    char* pName = strtok((char*)args, "");
    Player *player = nullptr;
...
static bool HandleResetTalentsCommand(const char * args)
{
    char* pName = strtok((char*)args, "");
    Player *player = nullptr;
    ObjectGuid playerGUID = ObjectGuid::Empty;
...
static bool HandleResetAllCommand(const char * args)
{
    ARGS_CHECK
