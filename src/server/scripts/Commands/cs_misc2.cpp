...
static bool HandleStartCommand(const char* /*args*/)
{
...
static bool HandleDismountCommand(const char* /*args*/)
{
...
static bool HandleSaveCommand(const char* /*args*/)
{
...
static bool HandleNamegoCommand(ChatHandler* handler, char const* args)
{
    ...
    {
        handler->PSendSysMessage(LANG_SUMMONING, name.c_str(), GetTrinityString(LANG_OFFLINE));
...
static bool HandleSaveAllCommand(const char* /*args*/)
{
...
static bool HandlePInfoCommand(ChatHandler* handler, char const* args)
{
    ...
    handler->PSendSysMessage(LANG_PINFO_ACCOUNT, (target ? "" : GetTrinityString(LANG_OFFLINE)), name.c_str(), targetGUID.GetCounter(), username.c_str(), accId, security, last_ip.c_str(), last_login.c_str(), latency);
...
static bool HandleRepairitemsCommand(const char* /*args*/)
{
...
static bool HandleUpdatePvPTitleCommand(const char *args)
{
...
static bool HandleCopyStuffCommand(char const * args)
{
    ARGS_CHECK
