...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    */
    ...
    PrepareStatement(CHAR_SEL_SUM_CHARS, "SELECT COUNT(guid) FROM characters WHERE account = ? AND deleteDate IS NOT NULL", CONNECTION_BOTH); //sunstrider: exclude pre deleted characters
    ...
    */
    ...
    PrepareStatement(CHAR_SEL_GROUP_MEMBER, "SELECT leaderGuid FROM group_member WHERE memberGuid =?", CONNECTION_BOTH);
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_AURAS, "SELECT caster_guid,spell,effect_index,stackcount,amount,maxduration,remaintime,remaincharges FROM character_aura WHERE guid = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_SEL_CHARACTER_SPELL, "SELECT spell,active,disabled FROM character_spell WHERE guid = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_SEL_CHARACTER_QUESTSTATUS, "SELECT quest,status,rewarded,explored,timer,mobcount1,mobcount2,mobcount3,mobcount4,itemcount1,itemcount2,itemcount3,itemcount4 FROM character_queststatus WHERE guid = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_INVENTORY, "SELECT bag,slot,item,item_template FROM character_inventory JOIN item_instance ON character_inventory.item = item_instance.guid WHERE character_inventory.guid = ? ORDER BY bag,slot", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_ARENAINFO, "SELECT arenateamid, played_week, played_season, personal_rating FROM arena_team_member WHERE guid=?", CONNECTION_ASYNC);
    ...
    */
    PrepareStatement(CHAR_SEL_ITEM_INSTANCE, "SELECT owner_guid, template, container_guid, creator, gift_creator, stacks, duration, spell1_charges, spell2_charges, spell3_charges, spell4_charges, spell5_charges, flags, enchant1_id, enchant1_duration, enchant1_charges, enchant2_id, enchant2_duration, enchant2_charges, enchant3_id, enchant3_duration, enchant3_charges, enchant4_id, enchant4_duration, enchant4_charges, enchant5_id, enchant5_duration, enchant5_charges, enchant6_id, enchant6_duration, enchant6_charges, enchant7_id, enchant7_duration, enchant7_charges, enchant8_id, enchant8_duration, enchant8_charges, enchant9_id, enchant9_duration, enchant9_charges, enchant10_id, enchant10_duration, enchant10_charges, enchant11_id, enchant11_duration, enchant11_charges, property_seed, random_prop_id, durability FROM item_instance WHERE guid = ?", CONNECTION_SYNCH);
    PrepareStatement(CHAR_REP_ITEM_INSTANCE, "REPLACE INTO item_instance (guid, owner_guid, template, container_guid, creator, gift_creator, stacks, duration, spell1_charges, spell2_charges, spell3_charges, spell4_charges, spell5_charges, flags, enchant1_id, enchant1_duration, enchant1_charges, enchant2_id, enchant2_duration, enchant2_charges, enchant3_id, enchant3_duration, enchant3_charges, enchant4_id, enchant4_duration, enchant4_charges, enchant5_id, enchant5_duration, enchant5_charges, enchant6_id, enchant6_duration, enchant6_charges, enchant7_id, enchant7_duration, enchant7_charges, enchant8_id, enchant8_duration, enchant8_charges, enchant9_id, enchant9_duration, enchant9_charges, enchant10_id, enchant10_duration, enchant10_charges, enchant11_id, enchant11_duration, enchant11_charges, property_seed, random_prop_id, durability) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", CONNECTION_ASYNC);
    PrepareStatement(CHAR_UPD_ITEM_INSTANCE, "UPDATE item_instance SET guid = ? , owner_guid = ? , template = ? , container_guid = ? , creator = ? , gift_creator = ? , stacks = ? , duration = ? , spell1_charges = ? , spell2_charges = ? , spell3_charges = ? , spell4_charges = ? , spell5_charges = ? , flags = ? , enchant1_id = ? , enchant1_duration = ? , enchant1_charges = ? , enchant2_id = ? , enchant2_duration = ? , enchant2_charges = ? , enchant3_id = ? , enchant3_duration = ? , enchant3_charges = ? , enchant4_id = ? , enchant4_duration = ? , enchant4_charges = ? , enchant5_id = ? , enchant5_duration = ? , enchant5_charges = ? , enchant6_id = ? , enchant6_duration = ? , enchant6_charges = ? , enchant7_id = ? , enchant7_duration = ? , enchant7_charges = ? , enchant8_id = ? , enchant8_duration = ? , enchant8_charges = ? , enchant9_id = ? , enchant9_duration = ? , enchant9_charges = ? , enchant10_id = ? , enchant10_duration = ? , enchant10_charges = ? , enchant11_id = ? , enchant11_duration = ? , enchant11_charges = ? , property_seed = ? , random_prop_id = ? , durability = ? WHERE guid = ?", CONNECTION_ASYNC);
    ...
    */
    // Auras
    PrepareStatement(CHAR_INS_AURA, "INSERT INTO character_aura (guid, caster_guid, spell, effect_index, stackcount, amount, maxduration, remaintime, remaincharges) "
                     "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
    /*
    #ifdef LICH_KING
    // Account data
    ...
    */
    ...
    PrepareStatement(CHAR_DEL_GROUP_INSTANCE_BY_GUID, "DELETE FROM group_instance WHERE leaderGuid = ? AND instance = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_REP_GROUP_INSTANCE, "REPLACE INTO group_instance (leaderGuid, instance, permanent) VALUES (?, ?, ?)", CONNECTION_ASYNC);
