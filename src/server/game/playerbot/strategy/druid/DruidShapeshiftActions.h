...
namespace ai {
    ...
    public: 
        ...
        virtual ActionList getAlternatives() {
            return NextAction::merge(NextAction::array({ std::make_shared<NextAction>("bear form") }), CastSpellAction::getAlternatives());
        }
    };
    ...
    public: 
        ...
        virtual bool isUseful() {
            return ai->HasAnyAuraOf(GetTarget(), { "dire bear form", "bear form", "cat form", "travel form", "aquatic form",
                "flight form", "swift flight form", "moonkin form", "tree of life" });
        }
