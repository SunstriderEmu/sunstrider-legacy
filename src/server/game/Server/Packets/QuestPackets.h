    ...
    namespace Quest
    {
...
#else
            // This field is calculated with player level. Since this is dynamic data, this is a temp value and is modified in a hack in SendQuestQueryResponse
            uint32 RewardHonorForPlayer     = 0;
#endif
            uint32 StartItem                = 0;
            uint32 Flags                    = 0;
        ...
        class QueryQuestInfoResponse final : public ServerPacket
        {
            public:
                ...
                QuestInfo Info;
#ifndef LICH_KING
                //sun: used to workaround the honor field which is dynamic on TBC
                static size_t RewardHonorForPlayerPos; // initialized at first Write and never changes
#endif
        };
    }
}
