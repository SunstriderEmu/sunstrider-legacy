...
bool ChatHandler::HandleQuestAddCommand(const char* args)
{
...
bool ChatHandler::HandleQuestCompleteCommand(const char* args)
{
    Player* player = GetSelectedPlayerOrSelf();
    if(!player)
    {
...
bool ChatHandler::HandleQuestReportCommand(const char* args)
{
    ARGS_CHECK
...
bool ChatHandler::HandleQuestTotalCountCommand(const char* args)
{
