...
std::vector<ChatCommand> const& ChatHandler::getCommandTable()
{
    ...
    static std::vector<ChatCommand> debugCommandTable =
    {
        ...
        { "threatlist",     SEC_GAMEMASTER3,  false, &ChatHandler::HandleDebugThreatListCommand,       "" },
        { "threatunitlist", SEC_GAMEMASTER3,  false, &ChatHandler::HandleDebugCombatListCommand,           "" },
