...
std::vector<ChatCommand> const& ChatHandler::getCommandTable()
{
    ...
    static std::vector<ChatCommand> debugCommandTable =
    {
        ...
        { "threatlist",     SEC_GAMEMASTER2,  false, &ChatHandler::HandleDebugThreatListCommand,       "" },
        { "threatunitlist", SEC_GAMEMASTER2,  false, &ChatHandler::HandleDebugCombatListCommand,       "" },
        { "threatinfo",     SEC_GAMEMASTER2,  false, &ChatHandler::HandleDebugThreatInfoCommand,       "" },
    ...
    static std::vector<ChatCommand> reloadCommandTable =
    {
        ...
        { "creature_movement_override",  SEC_ADMINISTRATOR, true, &ChatHandler::HandleReloadCreatureMovementOverrideCommand,"" },
        ...
        { "spell_group",                 SEC_ADMINISTRATOR, true, &ChatHandler::HandleReloadSpellGroupsCommand,             "" },
        { "spell_group_stack_rules",     SEC_ADMINISTRATOR, true, &ChatHandler::HandleReloadSpellGroupStackRulesCommand,    "" },
        ...
        { "spell_proc",                  SEC_ADMINISTRATOR, true, &ChatHandler::HandleReloadSpellProcCommand,               "" },
   ...
   static std::vector<ChatCommand> testCommandTable = 
   {
       ...
       { "join",           SEC_ADMINISTRATOR, false, &ChatHandler::HandleTestsJoinCommand,                  "" },
