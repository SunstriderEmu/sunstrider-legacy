...
void PetitionMgr::RemovePetitionsByOwnerAndType(SQLTransaction trans, ObjectGuid ownerGuid, CharterTypes type)
{
...
void PetitionMgr::RemoveSignaturesBySignerAndType(SQLTransaction trans, ObjectGuid signerGuid, CharterTypes type)
{
    for (auto& petitionPair : _petitionStore)
    {
