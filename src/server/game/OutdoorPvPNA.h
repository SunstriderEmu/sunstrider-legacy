...
const go_type HordeControlGOs[NA_CONTROL_GO_NUM] = {
    {182267,530,-1815.80f,8036.51f,-26.2354f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //ALLY_ROOST_SOUTH
    {182280,530,-1507.95f,8132.10f,-19.5585f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //ALLY_ROOST_WEST
    {182281,530,-1384.52f,7779.33f,-11.1663f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //ALLY_ROOST_NORTH
    {182282,530,-1650.11f,7732.56f,-15.4505f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}, //ALLY_ROOST_EAST

    {182222,530,-1825.4022f,8039.2602f,-26.08f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //HORDE_BOMB_WAGON_SOUTH
    {182272,530,-1515.3700f,8136.9100f,-20.42f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //HORDE_BOMB_WAGON_WEST
    {182273,530,-1377.9500f,7773.4400f,-10.31f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //HORDE_BOMB_WAGON_NORTH
    {182274,530,-1659.8700f,7733.1500f,-15.75f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}, //HORDE_BOMB_WAGON_EAST

    {182266,530,-1815.80f,8036.51f,-26.2354f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //DESTROYED_ALLY_ROOST_SOUTH
    {182275,530,-1507.95f,8132.10f,-19.5585f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //DESTROYED_ALLY_ROOST_WEST
    {182276,530,-1384.52f,7779.33f,-11.1663f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //DESTROYED_ALLY_ROOST_NORTH
    {182277,530,-1650.11f,7732.56f,-15.4505f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}  //DESTROYED_ALLY_ROOST_EAST
};

// spawned when the horde is attacking, alliance is in control
const go_type AllianceControlGOs[NA_CONTROL_GO_NUM] = {
    {182301,530,-1815.80f,8036.51f,-26.2354f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //HORDE_ROOST_SOUTH
    {182302,530,-1507.95f,8132.10f,-19.5585f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //HORDE_ROOST_WEST
    {182303,530,-1384.52f,7779.33f,-11.1663f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //HORDE_ROOST_NORTH
    {182304,530,-1650.11f,7732.56f,-15.4505f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}, //HORDE_ROOST_EAST

    {182305,530,-1825.4022f,8039.2602f,-26.08f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //ALLY_BOMB_WAGON_SOUTH
    {182306,530,-1515.3700f,8136.9100f,-20.42f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //ALLY_BOMB_WAGON_WEST
    {182307,530,-1377.9500f,7773.4400f,-10.31f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //ALLY_BOMB_WAGON_NORTH
    {182308,530,-1659.8700f,7733.1500f,-15.75f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}, //ALLY_BOMB_WAGON_EAST

    {182297,530,-1815.80f,8036.51f,-26.2354f,-2.897250f,0.0f,0.0f,0.992546f,-0.121869f}, //DESTROYED_HORDE_ROOST_SOUTH
    {182298,530,-1507.95f,8132.10f,-19.5585f,-1.343900f,0.0f,0.0f,0.622515f,-0.782608f}, //DESTROYED_HORDE_ROOST_WEST
    {182299,530,-1384.52f,7779.33f,-11.1663f,-0.575959f,0.0f,0.0f,0.284015f,-0.958820f}, //DESTROYED_HORDE_ROOST_NORTH
    {182300,530,-1650.11f,7732.56f,-15.4505f,-2.809980f,0.0f,0.0f,0.986286f,-0.165048f}  //DESTROYED_HORDE_ROOST_EAST
};
...
const creature_type HordeControlNPCs[NA_CONTROL_NPC_NUM] = {
    ...
    {21484,67,530,-1524.84f,7930.34f,-20.1820f,3.64050f},
    {21483,67,530,-1570.01f,7993.80f,-22.4505f,5.02655f},
    {18192,67,530,-1654.06f,8000.46f,-26.5900f,3.37000f},
    {18192,67,530,-1487.18f,7899.10f,-19.5300f,0.95400f},
    {18192,67,530,-1480.88f,7908.79f,-19.1900f,4.48500f},
    {18192,67,530,-1540.56f,7995.44f,-20.4500f,0.94700f},
    {18192,67,530,-1546.95f,8000.85f,-20.7200f,6.03500f},
    {18192,67,530,-1595.31f,7860.53f,-21.5100f,3.74700f},
    {18192,67,530,-1642.31f,7995.59f,-25.8000f,3.31700f},
    {18192,67,530,-1545.46f,7995.35f,-20.6300f,1.09400f},
    {18192,67,530,-1487.58f,7907.99f,-19.2700f,5.56700f},
    ...
    {18192,67,530,-1550.60f,7944.45f,-21.6300f,3.55900f},
    {18192,67,530,-1545.57f,7935.83f,-21.1300f,3.44800f},
    {18192,67,530,-1550.86f,7937.56f,-21.7000f,3.80100f}
};
