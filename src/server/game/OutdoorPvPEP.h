...
const go_type EPTowerFlags[EP_TOWER_NUM] = {
    {182106,0,2569.60,-4772.93f,115.399f,2.722710f,0.0f,0.0f,0.978148f,0.207912f},
    {182106,0,3148.17,-4365.51f,145.029f,1.535890f,0.0f,0.0f,0.694658f,0.719340f},
    {182106,0,2992.63,-3022.95f,125.593f,3.036870f,0.0f,0.0f,0.998630f,0.052336f},
    {182106,0,1838.42,-3703.56f,167.713f,0.890118f,0.0f,0.0f,0.430511f,0.902585f}
};
