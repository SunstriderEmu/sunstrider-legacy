...
DELETE FROM eventai_scripts WHERE id IN (366916, 367014, 367115, 367313, 365404);
INSERT INTO eventai_scripts (id, creature_id,event_type,event_chance,event_flags,action1_type,action1_param1,action1_param2,comment) VALUES
(366916, 3669,6,100,6,34,1,3,'Lord Cobrahn - Set Inst Data on Death'),
(367014, 3670,6,100,6,34,2,3,'Lord Pythas - Set Inst Data on Death'),
(367115, 3671,6,100,6,34,3,3,'Lady Anacondra - Set Inst Data on Death'),
(367313, 3673,6,100,6,34,4,3,'Lord Serpentis - Set Inst Data on Death'),
(365404, 3654,6,100,6,34,9,3,'Mutanus the Devourer - Set Inst Data on Death');

DELETE FROM escort_waypoints WHERE entry=3678;
