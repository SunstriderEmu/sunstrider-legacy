...
INSERT INTO creature (id, map, spawnmask, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, movementtype)
VALUES (15689, 532, 1, -11134, -1582.82, 278.794, 4.47585, 604800, 5, 2);

DELETE FROM spell_linked_spell WHERE spell_effect IN (38637, 38638, 38639);
