...
MySQL - 5.5.41-MariaDB-1~wheezy-log : Database - auth
*********************************************************************
*/
...
insert  into `account_access`(`id`,`gmlevel`,`RealmID`) values (1,5,-1),(2,5,-1),(3,5,-1),(4,5,-1),(5,5,-1);
...
insert  into `rbac_default_permissions`(`secId`,`permissionId`,`realmId`) values (0,195,-1),(1,194,-1),(2,193,-1),(3,192,-1);
